  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      <button
        ...
        className={`flex items-center justify-between text-[#5D4E42] hover:text-[#B88A5A] focus:outline-none transition-colors duration-200 cursor-pointer ${
          compact ? 'py-1 text-[11px] font-semibold gap-1' : 'py-1 text-xs font-semibold gap-1.5'
        }`}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center space-x-5 xl:space-x-7 flex-1 justify-end">
              <a
                href="/#order"
                onClick={(e) => handleSectionClick(e, '/#order')}
                className="px-5 py-2 text-xs xl:text-[13px] font-semibold uppercase tracking-[0.2em] text-[#5D4E42] hover:text-[#B88A5A] transition-all duration-250"
              >
                Order Now
              </a>
